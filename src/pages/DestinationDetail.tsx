...
export default function DestinationDetail() {
  ...
  const destination: Destination = {
    ...rawDestination,
    price: Number(t(`destinations.${rawDestination.id}.price`)),
    title: t(`destinations.${rawDestination.id}.title`),
          ...
          >
            ...
            <div className="flex flex-wrap gap-8 mb-12">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-orange-100 flex items-center justify-center text-orange-600">
                  <span className="font-bold text-lg">{t('common.currencySymbol')}</span>
                </div>
                <div>
                  <div className="text-[10px] uppercase tracking-widest text-stone-400 font-bold">{t('common.price')}</div>
                  <div className="font-bold">{t('common.currencySymbol')}{destination.price}</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-white p-8 rounded-3xl border border-stone-100 shadow-sm">
                ...
                <img 
                  src={t('common.jacuzziLogo')} 
                  alt="Jacuzzi Logo" 
                  className="mt-6 w-full rounded-2xl block min-h-[200px] bg-stone-100 object-contain"
                />
              </div>
              <div className="bg-white p-8 rounded-3xl border border-stone-100 shadow-sm">
